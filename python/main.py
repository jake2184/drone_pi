...
if __name__ == '__main__':
    ...
    imageUploadThread = threading.Thread(target=send_latest_image, args=(url, port))
    imageUploadThread.daemon = True
    imageUploadThread.start()

    # Thread to upload audio
    audioUploadThread = threading.Thread(target=send_latest_audio, args=(url, port))
